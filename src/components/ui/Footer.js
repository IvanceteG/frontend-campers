        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#inici" className="footer-link">
                  Inici
                </Link>
              </li>
              <li>
                <Link href="#models" className="footer-link">
                  Catàleg
                </Link>
              </li>
              <li>
                <Link href="#opinions" className="footer-link">
                  Opinions
                </Link>
              </li>
              <li>
                <Link href="#contacte" className="footer-link">
                  Contacte
                </Link>
              </li>
            </ul>
